...
void ConfigureSurface() {
    ...
    wgpu::SurfaceConfiguration config{
        .device = device, .format = format, .width = kWidth, .height = kHeight, .presentMode = wgpu::PresentMode::Fifo};
...
void Init() {
    ...
    wgpu::Future f1 =
        instance.RequestAdapter(nullptr, wgpu::CallbackMode::WaitAnyOnly,
    ...
    wgpu::Future f2 =
        adapter.RequestDevice(&desc, wgpu::CallbackMode::WaitAnyOnly,
